"""Main application for Message Service."""
...
app = FastAPI(
    title="Colink Message Service",
    description="Message management service for Colink Slack Clone",
...
# Add authentication middleware FIRST (runs after CORS due to reverse order)
app.add_middleware(AuthMiddleware)

# Add CORS middleware LAST (runs first due to reverse order, adds headers even on 401)
app.add_middleware(
    CORSMiddleware,
